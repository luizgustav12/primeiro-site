            ...
            <div class="form-body">
                <form name="form-alteracao" id="alteracao" action="../ajax/alterar.php" method="post" data-toggle="validator" role="form">
                    <fieldset>
                        ...
                        <input type="text"  id="nome"  required  name="nome"  size="81" maxlength="60" value="<?php echo $nome ?>">

                        <a id="indicador-email">Email:</a>
                        <input type="email" id="email" required  name="email" size="81" maxlength="60" value="<?php echo $email ?>">

                        <a id="indicador-telefone">Telefone:</a>
                        <input type="tel" id="telefone" required  name="telefone" size="81" maxlength="15" value="<?php echo $telefone ?>">

                        <a id="indicador-senha-atual">Senha atual:</a>
                        <input type="password" id="senha_atual" required  name="senha_atual" size="81" maxlength="25" >
                        
                        <a id="indicador-nova-senha">Nova senha:</a>
                        <input type="password" id="nova_senha" required  name="nova_senha" size="81" maxlength="25" >
                        
                        <a id="indicador-confirma">Confirmar nova senha:</a><br>
                        <input type="password" id="confirma_senha" required  name="confirma_senha" size="81" maxlength="25" >
