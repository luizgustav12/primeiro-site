        ...
        <div class="form-body">
            ...
            <form name="form-cadastro" id="cadastro" action="../ajax/cadastro.php" method="post" data-toggle="validator" role="form">
                <fieldset>
                    ...
                    <input type="text"  id="nome"  required  name="nome"  size="55" maxlength="60" placeholder=" João">

                    <a id="indicador-email">Email:</a>
                    <input type="email" id="email" required  name="email" size="55" maxlength="60" placeholder=" joao@gmail.com">

                    <a id="indicador-telefone">Telefone:</a>
                    <input type="tel" id="telefone" required  name="telefone" size="55" maxlength="15" placeholder=" (99) 9999-9999" >
